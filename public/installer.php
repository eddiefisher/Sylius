...
if (!version_compare(phpversion(), '5.3.2', '>=')) {
    $version = phpversion();
    $issues[] = <<<EOF
        You are running PHP version "<strong>$version</strong>", but Sylius
        needs at least PHP "<strong>5.3.2</strong>" to run. Before using Sylius, install
...
if (!is_writable(__DIR__ . '/../sylius/cache')) {
    $issues[] = 'Change the permissions of the "<strong>sylius/cache/</strong>"
        directory so that the web server can write into it.';
}

if (!is_writable(__DIR__ . '/../sylius/logs')) {
    $issues[] = 'Change the permissions of the "<strong>sylius/logs/</strong>"
        directory so that the web server can write into it.';
}
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p><strong>Error.</strong> It looks like your system does not meet the requirements of <strong>Sylius</strong>.</p>
                </div>
